...
def fetch_ontology_details(ontology_id):
    """
    Fetches and returns details about a specific ontology from the Ontology Lookup Service.
    """
...
def print_ontology_info(ontology_id):
    """
    Fetches ontology details and prints them in a human-readable format.
    """
